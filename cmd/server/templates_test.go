...
func TestTemplatesRender(t *testing.T) {
	...
	cases := map[string]any{
		...
		"admin-bookings": adminBookingsData{Flash: flash{OK: "saved"}, Status: "new", Source: db.SourceGoogleAds, Statuses: db.BookingStatuses,
			...
			Rows:    bookingRows([]db.Booking{booked, {ID: 2, Name: "Unscheduled", PreferredTime: "arvo", Status: "new"}})},
		"admin-booking": adminBookingData{Flash: flash{Err: "oops"}, B: &booked, Row: newBookingRow(booked), Cust: cust,
			...
			Click: &db.AdClick{Token: "tok", Source: db.SourceGoogleAds, GCLID: "abc123", Keyword: "computer technician near me",
				Campaign: "22334455", Landing: "/computer-help/donvale", BookingID: 1, CreatedAt: time.Now()}},
